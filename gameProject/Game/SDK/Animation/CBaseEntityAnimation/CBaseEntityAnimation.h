...
enum CBaseEntityAnimationType {
	...
	MAGICSPELLING_FORWARD ,
	MAGICSPELLING_BACKWARD ,
	MAGICSPELLING_LEFT ,
	MAGICSPELLING_RIGHT ,

	// Attacking while walking
	MAGICSPELLING_WALKING_FORWARD ,
	MAGICSPELLING_WALKING_BACKWARD ,
	MAGICSPELLING_WALKING_LEFT ,
	MAGICSPELLING_WALKING_RIGHT ,

	// Attacking while running
	MAGICSPELLING_RUNNING_FORWARD ,
	MAGICSPELLING_RUNNING_BACKWARD ,
	MAGICSPELLING_RUNNING_LEFT ,
	MAGICSPELLING_RUNNING_RIGHT ,
